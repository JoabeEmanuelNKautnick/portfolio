        ...
        <div class="footer-container">
            <div class="footer-content">
                ...
                <div class="footer-social">
                    ...
                    <a href="#" class="social-link" aria-label="Email" target="_blank" rel="noopener noreferrer">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                ...
                <p class="footer-copyright">
                    &copy; <?php echo date('Y'); ?> Portfolio. <?php echo t('footer_rights'); ?>
                </p>
                
                <!-- Made with -->
                <p class="footer-made">
                    <?php echo t('footer_made'); ?> 💜
                </p>
            </div>
        </div>
    </footer>
